...
class ConsoleManager:
    ...
    def __init__(self, silent: bool) -> None:
        """
        Инииализация консольного менеджера
    ...
    def progress(self) -> Progress:
        ...
        Returns:
            (Progress): контекстный менджер для отслеживания прогресса
    ...
    def print_log(self, message: str) -> None:
        ...
        Examples:
            >>> console_manager: ConsoleManager = ConsoleManager()
            >>> console_manager.print_log("Информация")
    ...
    def print_error(self, message: str) -> None:
        ...
        Examples:
            >>> console_manager: ConsoleManager = ConsoleManager()
            >>> console_manager.print_error("ошибка")
